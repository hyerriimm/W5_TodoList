...
export const __getComments = createAsyncThunk(
  ...
  async (payload, thunkAPI) => {
    try {
      const data = await axios.get("https://vast-escarpment-98213.herokuapp.com/comments");
...
export const comments = createSlice({
  ...
  reducers: { // 이 모듈의 Reducer 로직
    ...
    createComment(state, action) {
      ...
      axios.post("https://vast-escarpment-98213.herokuapp.com/comments",action.payload);
    },
    ...
    deleteComment(state, action) {
      ...
      axios.delete(`https://vast-escarpment-98213.herokuapp.com/comments/${action.payload}`);
    },
    ...
    updateComment(state, action) {
      ...
      axios.patch(`https://vast-escarpment-98213.herokuapp.com/comments/${action.payload.id}`,action.payload);
    },
  },
  extraReducers: {
